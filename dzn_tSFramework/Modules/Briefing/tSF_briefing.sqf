...
"Более взвода пехоты ВС Республики Кубы<br />Гарнизон острова Porto"
END
...
TOPIC("II. Задание:")
"1. Найти CV Santa Castaneda<br />2. Найти и идентифицировать груз. Дополнительно: если груз военного назначения (военная техника или боеприпасы) - уничтожить его на месте.<br />3. Эвакуироваться на USS Khe Sanh<br />"
END

TOPIC("III. Выполнение:")
"Ваш отряд был скрытно переброшен на остров с подводной лодки и находится на северо-востоке острова. Предполагаемое место крушения корабля находится на юго-западе. Около места высадки разведка обнаружила командный пункт гарнизона и бункер у дороги. Кубинцы оставили там несколько человек для охраны. В городе противника нет. <br /><br />К западу от населённого пункта находится наблюдательный пункт, с которого возможно есть видимость на корабль.<br />Основные силы противника находятся на берегу и занимаются спасением груза. <br /><br />Точка эвакуации - десатный корабль Khe Sanh ВМФ США"
END
